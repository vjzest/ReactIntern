...
function MyTicket() {
  ...
  return (
    <div>
      <h6 className="text-3xl font-semibold">My Ticket</h6>
      <div className="px-20 py-10 bg-teal-100 h-screen">
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex justify-between items-center mt-4">
            <div>Showing 1 to 5 of {tickets.length} entries</div>
            <div className="flex space-x-2">
              <button className="text-teal-500 hover:text-teal-600">
                &lt;&lt;
              </button>
              <button className="text-teal-500 hover:text-teal-600">1</button>
              <button className="text-teal-500 hover:text-teal-600">2</button>
              <button className="text-teal-500 hover:text-teal-600">3</button>
              <button className="text-teal-500 hover:text-teal-600">
                &gt;&gt;
              </button>
            </div>
